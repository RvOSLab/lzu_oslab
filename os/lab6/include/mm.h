...
#define GET_PAGE_ADDR_BITS(pte) (( (pte) & 0x3FFFFFFFFFFC00) >> 10)
#define SET_PAGE_ADDR(pte, addr) ((pte) = (addr) >> 2 | GET_FLAG(pte))
#define SET_PAGE_ADDR_BITS(pte, content) ((pte) = (content) << 10 | GET_FLAG(pte))
