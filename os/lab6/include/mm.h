...
#define PLIC_THRESHOLD_ADDRESS (PLIC_START_ADDRESS + PLIC_THRESHOLD)
#define PLIC_CLAIM_ADDRESS (PLIC_START_ADDRESS + PLIC_CLAIM)
#define PLIC_COMPLETE_ADDRESS (PLIC_START_ADDRESS + PLIC_COMPLETE)
