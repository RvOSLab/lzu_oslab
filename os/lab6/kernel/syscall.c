 ...
 * 所有系统调用都通过系统调用表调用
 */
fn_ptr syscall_table[] = {sys_init, sys_fork, sys_test_fork, sys_getpid, sys_getppid, sys_char, sys_block, sys_open, sys_close, sys_stat, sys_read, sys_reset, sys_brk, sys_sigaction, sys_kill, sys_exit, sys_sigreturn, sys_setpriority};
