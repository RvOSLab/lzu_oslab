...
#define VIRTIO_START_ADDRESS (CEIL(UART_END_ADDRESS))
#define VIRTIO_END_ADDRESS (VIRTIO_START_ADDRESS + VIRTIO_LENGTH)
#define VIRTIO_QUEUE_START_ADDRESS (CEIL(VIRTIO_END_ADDRESS))
#define VIRTIO_QUEUE_END_ADDRESS (VIRTIO_QUEUE_START_ADDRESS + VIRTIO_QUEUE_LENGTH)
